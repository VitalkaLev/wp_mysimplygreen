            ...
            <div class="fsBody " id="fsLocal">
                <form method="post" novalidate enctype="multipart/form-data"
                    ...
                    <div class="fsPage" id="fsPage3847518-1">
                        ...
                        <div id="fsRow3847518-2" class="fsRow fsFieldRow fsLastRow">
                        ...
                        <div id="fsRow3847518-3" class="fsRow fsFieldRow fsLastRow">
                            <div class="fsRowBody fsCell fsFieldCell fsFirst fsLast fsLabelVertical fsSpan100"
                                id="fsCell91397839" lang="en" fs-field-type="phone"
                                fs-field-validation-name="Phone number">
